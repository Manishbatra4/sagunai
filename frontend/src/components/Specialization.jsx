...
const Specialization = () => {
  const { special, deleteSpecial } = useContext(SpecContext);
  ...
  return (
    <div className="p-8">
      ...
      <div className="grid grid-cols-4 gap-4">
        {special &&
          special.map((spec) => (
            <div
              key={spec.id}
              className="max-w-sm bg-slate-800 text-white rounded overflow-hidden shadow-lg"
            >
      ...
      >
        ...
        <SpecialForm data={""} type={"new"} close={closeModal} />
      </Modal>
      ...
      >
        ...
        <SpecialForm data={selected} type={"update"} close={closeModal1} />
      </Modal>
    </div>
  );
};
